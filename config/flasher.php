...
return Configuration::from([
    ...
    'options' => [
        ...
        'progress_bar' => true, // Enable or disable the progress bar (default: true)
        'close_button' => true, // Whether or not to show the close button (default: true)
        'newest_on_top' => true, // Whether to show newest notifications on top (default: true)
    ],
