...
class CategoryController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('admin.product.category.index')->with('success', '建立成功');;
    }
    ...
    public function update(Request $request, string $id)
    {
        ...
        return redirect()->route('admin.product.category.index')->with('success', '更新成功');
    }
    ...
    public function destroy(string $id)
    {
        ...
        return response(['status' => 'success', '刪除成功']);
    }
